    ...
    case ROW_TYPE.BREED:
      return (
        <View style={styles.rowView}>
          <Entypo name="baidu" color="black" size={20} style={styles.icon} />
          <Text>
            {label}: <B>{data}</B>
          </Text>
        </View>
        ...
        <View style={styles.rowView}>
          ...
          {data >= 12 && (
            <Text>
              {label}:{" "}
              <B>
                {Math.floor(data / 12)} {age2Polish(data)}
              </B>
            </Text>
          )}
        </View>
    ...
    default:
      return (
        <Text
          style={
            ([styles.rowView],
            { textAlign: "justify", marginTop: 15, marginBottom: 25 })
          }
        >
          {data}
        </Text>
